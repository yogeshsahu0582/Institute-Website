...
<!-- Content Starting  -->
<div class="headimg"><img src="image/classs.jpg" width="100%" height="200px" style="padding:10px; border-radius: 25px;"></div>


<center><div class="w3-panel w3-card w3-light-green" style="padding:20px; width: 60%;position: relative; margin: 20px; border-radius:25px"> 
  <h2><img src="image/classroom.png" width="40px"> Classrooms</h2>
  <div class="w3-code htmlHigh notranslate w3-teal" style="font-size: 20px;text-align: justify;">

    <h2 class="w3-center">Classroom - Gallery</h2>

    <div class="w3-content w3-section w3-dark-grey" style="width: 100%; padding: 10px;" >
      <img class="mySlides" src="image/class3.jpg" style="width:100%">
      <img class="mySlides" src="image/class2.jpg" style="width:100%">  
      <img class="mySlides" src="image/class.jpg" style="width:100%">
      <img class="mySlides" src="image/class4.jpg" style="width:100%">
      <img class="mySlides" src="image/class5.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: skyblue;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Classroom</u></h1>
  <p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">
    The Govt. Polytechnic College Betul have around 20- classrooms, 3- Computer Labs, 10- Workshops & others. 
    <br>
    <br>
    The Govt. Polytechnic College classrooms is a positive place where a student can come to work toward specific goals set before them in the class objectives.<br>
<br>
    The environment of GPC -classroom is so peacefully. Where student learns better and gets intrest in studies and also do hard work and get suceed.
