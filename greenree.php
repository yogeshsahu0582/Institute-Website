...
<div class="headimg"><img src="image/green.jpg" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>

    <center><div class="w3-panel w3-card w3-light-green" style="padding:20px; width: 70%;position: relative; margin: 20px; border-radius:25px">  
      <h2><img src="image/classroom.png" width="40px"> College - Greenree</h2>
      <div class="w3-code htmlHigh notranslate w3-teal" style="font-size: 20px;text-align: justify;">

        <h2 class="w3-center">College Greenree - Gallery</h2>

        <div class="w3-content w3-section w3-dark-grey" style="width: 90%; padding: 10px;" >
          <img class="mySlides" src="image/g1.jpg" style="width:100%">
          <img class="mySlides" src="image/g2.jpg" style="width:100%">  
          <img class="mySlides" src="image/g3.jpg" style="width:100%">
          <img class="mySlides" src="image/g4.jpg" style="width:100%">
          <img class="mySlides" src="image/g5.jpg" style="width:100%">
          <img class="mySlides" src="image/g6.jpg" style="width:100%">
          <img class="mySlides" src="image/g7.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: skyblue;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Greenree</u></h1>
  <p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">
    The Govt. Polytechnic College is surrounded by all green tree and plant. Every Year Our College plant more and more tree. Our College plant Berry trees, Amla trees, Mango trees and many other tree surround the college. 
    <br>
    <br>
    Environment of GPC - Betul is full of fresh air & peace. GPC Environment makes Students and Faculties mind fresh and active for sduty, Where student gains a lot of knowledge without disturbance.
