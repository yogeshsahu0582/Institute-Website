...
<body>
	...
	<div class="headimg"><img src="image/ETE.jpg" width="100%" height="250px"></div>
<br>

		<div class="w3-row">
			<div class="w3-col w3-container m4 l3">
				<div class="w3-half w3-purple w3-container" style=" border-radius: 25px; height:auto; width:100%">
					<div class="w3-padding-64 w3-center">
						<h1>HOD DESK</h1>
						<img src="image/deepika.jpg" class="w3-margin w3-circle" alt="Person" style="width:80%">
						<div class="w3-left-align w3-padding-large" style=" line-height: 2;">

							<h5 style="font-family:sans-serif;"><b><center>Mrs. Deepika Sakre</center></b></h5>
							<p style="font-family:sans-serif;text-align: center;">HEAD OF DEPARTMENT</p>
							<p style="font-family:sans-serif; text-align: center;">Electronics & TeleCommunication Engg.</p>
	...
	<!--Faculty Desk-->
			...
			<div class="w3-col w3-container m8 l9">  
				<center><p style="background-color:lightskyblue;" class="w3-xxlarge font-effect-shadow-multiple">FACULTIES DESK</p></center>
				<br>
					...
					<ul class="w3-ul w3-card-4">
						<li class="w3-bar">
							...
							<div class="w3-dropdown-hover">
								<img src="image/deepika.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/deepika.jpg"style="width:100%">
								</div>
							</div>
							
							<div class="w3-bar-item">
								<span class="w3-large">Mrs. Deepika Sakre</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/manish.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/manish.jpeg" style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large"> Mr. Manish Chourasia</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/vasant.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/vasant.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Vasant Singh Dhurve</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/rajput.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/rajput.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Neeraj Singh Rajput</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/morle.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/morle.jpeg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. R.K. Morle</span><br>
								<span>Lab Asistant</span>
							</div>
						</li>
					</ul>
				</div>
...
<br>
<br>
<div class="w3-container" style="background-color: gainsboro;"><h2 style="text-align:center;font-family: cursive; font-weight: bold;"><u>Info@Electronics & TeleCommunication Engg.</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">Diploma In Electronics and TeleCommunication Engineering is a  diploma level Electronics and Telecommunication Engineering course.The focus of the course is on understanding electronics networks and devices, electric magnetic fields, computer fundamental, communications and control systems. Diploma in Electronics and TeleCommunication Engineering is a 3 year course. The academic program is divided into 6 semesters. </p>
</div>
<br>
