...
<body>
  ...
  <br>
    ...
    <div class="headimg"><img src="image/hostels.jpg" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>
<br>
    <div class="w3-row">
      <div class="w3-col w3-container m4 l3" style="padding:20px;">
        <div class="w3-half w3-brown w3-container" style="border-radius: 25px; height:auto; width:100%">
          <div class="w3-padding-64 w3-center">
            <h1>INCHARGE</h1>
            <img src="image/morle.jpeg" class="w3-margin w3-circle" alt="Person" style="width:200px">
            <div class="w3-left-align w3-padding-large" style="line-height: 2;">

              <h3 style="font-family:sans-serif;"><b><center>Mr. R.K. Morle</center></b></h3>
              <p style="font-family:sans-serif;font-size: 20px; text-align: center;">Hostel Incharge</p>
      ...
      <div class="w3-col w3-container m8 l9" >  
        <div class="w3-container">
          ...
          <div class="w3-panel w3-card w3-blue-grey" style="border-radius:25px"> 
            <h2><img src="image/lab.png" width="40px"> Boys Hostel</h2>

            <div class="w3-code htmlHigh notranslate w3-pink" style="font-size: 20px;text-align: justify;">

              <h2 class="w3-center">Boys Hostel - Gallery</h2>

              <div class="w3-content w3-section w3-dark-grey" style="max-width:90%; padding: 10px;" >
                <img class="mySlides" src="image/hos1.jpg" style="width:100%">
                <img class="mySlides" src="image/hos3.jpg" style="width:100%">  
                <img class="mySlides" src="image/hos4.jpg" style="width:100%">
                <img class="mySlides" src="image/hos5.jpg" style="width:100%">
                <img class="mySlides" src="image/hos8.jpg" style="width:100%">
                <img class="mySlides" src="image/hos9.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: lightsteelblue;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Hostel</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">

GPC Betul have two boys College Hostel named Vishwasaraiya Boys Hostel. In each Hostel Have 30 and above rooms. Each room have full Facilities  for students 
<br>
<br>

<b>Hostel Times:</b>Every Day - 6:00 a.m. to 9:00 p.m.
</p>
</div>
<br>
