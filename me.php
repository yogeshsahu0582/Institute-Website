...
<body>
	...
	<div class="headimg"><img src="image/ME.jpg" width="100%" height="250px"></div>
<br>

		<div class="w3-row">
			<div class="w3-col w3-container m4 l3">
				<div class="w3-half w3-blue-grey w3-container" style=" border-radius: 25px; height:auto; width:100%">
					<div class="w3-padding-64 w3-center">
						<h1>HOD DESK</h1>
						<img src="image/himwani.jpeg" class="w3-margin w3-circle" alt="Person" style="width:80%">
						<div class="w3-left-align w3-padding-large" style=" line-height: 2;">

							<h5 style="font-family:sans-serif;"><b><center>Mr. Jitendra Himwani</center></b></h5>
							<p style="font-family:sans-serif;text-align: center;">HEAD OF DEPARTMENT</p>
							<p style="font-family:sans-serif; text-align: center;">Mechenical Engineering</p>
					...
					<ul class="w3-ul w3-card-4">
						<li class="w3-bar">
							...
							<div class="w3-dropdown-hover">
								<img src="image/himwani.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/himwani.jpeg"style="width:100%">
								</div>
							</div>
							
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Jitendra Himwani</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/dehariya.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/dehariya.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Sunil Kumar Dehariya</span><br>
								<span>Lecturer + TPO</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/login.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/login.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Praveen Sharma </span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/rai.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/rai.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Chhatar Singh Rai</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							...
							<div class="w3-bar-item">
								<span class="w3-large"> Mrs. Yatna Bhagat</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/balram.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/balram.jpeg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. BALRAM KAVADE</span><br>
								<span>lacturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/sanju.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/sanju.jpeg" style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large"> Mr. Sanju Baraskar</span><br>
								<span>Lecturer</span>
							</div>
						</li>
					</ul>
...
<br>
<br>
<div class="w3-container" style="background-color: navajowhite;"><h2 style="text-align:center;font-family: cursive; font-weight: bold;"><u>Info@Mechanical-Engineering</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">Diploma in Mechanical Engineering is a 3 year Diploma course which deals with the field of engineering. Mechanical engineering is a discipline of engineering that applies the principles of physics and materials science for analysis, design, manufacturing, and maintenance of mechanical systems.</p>
</div>
<br>
<!-- Footer-->
