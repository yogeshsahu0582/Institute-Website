...
<body>
  ...
  <br>
    ...
    <div class="headimg"><img src="image/sports.png" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>
<br>

    <div class="w3-row">
      <div class="w3-col w3-container m4 l3" style="padding:20px">
        <div class="w3-half w3-green w3-container" style="border-radius: 25px; height:auto; width:100%">
          <div class="w3-padding-64 w3-center">
            <h1>INCHARGE</h1>
            <img src="image/laad.jpg" class="w3-margin w3-circle" alt="Person" style="width:200px">
            <div class="w3-left-align w3-padding-large" style="line-height: 2;">

              <h5 style="font-family:sans-serif;"><b><center>Mr. Ayush Kumar Laad</center></b></h5>
              <p style="font-family:sans-serif;text-align: center;">Sports & Events Club Coordinator</p>
      ...
      <div class="w3-col w3-container m8 l9">  
        <div class="w3-container">
          ...
          <div class="w3-panel w3-card w3-blue-grey" style="border-radius:25px"> 
            <h2><img src="image/sportslogo.jpg" width="40px"> GPC - Sports & Events</h2>

            <div class="w3-code htmlHigh notranslate w3-aqua" style="border-radius: 25px; font-size: 20px;text-align: justify;">

              <h2 class="w3-center">Sports & Events - Gallery</h2>

              <div class="w3-content w3-section w3-dark-grey" style="border-radius: 25px; max-width:90%; padding: 10px;" >
                <img class="mySlides" src="image/sp1.jpg" style="width:100%">
                <img class="mySlides" src="image/sp2.jpg" style="width:100%">  
                <img class="mySlides" src="image/sp5.jpg" style="width:100%">
                <img class="mySlides" src="image/event1.jpg" style="width:100%">
                <img class="mySlides" src="image/event2.jpg" style="width:100%">
                <img class="mySlides" src="image/event3.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: palegreen;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Sports</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">
Govt Polytechnic College Betul play a important role in student fitness and sports. With a vision to enhance the all round personality of the students, GPC Betul pays equal attention to sports and fitness. It constantly strives to see that the students grow intellectually as well as physically. They are regularly motivated to participate various sports and games both within and outside the campus. Sports competitions are organized and students are encouraged to participate.
<br>
<br>
The GPC Betul campus is well equipped with Badminton, Cricket Ground, Volley Ball Court, Table Tennis and other fitness activities.
<br>
<br>
The GPC Betul  is organized events every year like Chatorigali Competition, Matki Fod Compitition, Gali Cricket, Boys Cricket, Pittu, and many other games.
</p>
</div>
<br>
