...
<div class="w3-bar w3-brown" style="padding : 2px;">
  ...
  <div class="right-nav">
    ...
    <!-- Content Starting  -->
  <div class="headimg"><img src="image/trip.jpg" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>

    <center><div class="w3-panel w3-card w3-yellow" style="padding:20px; width: 70%;position: relative; margin: 20px; border-radius:25px"> 
      <h2><img src="image/classroom.png" width="40px"> GPC Betul- College Tours</h2>
      <div class="w3-code htmlHigh notranslate w3-teal" style="font-size: 20px;text-align: justify;">

        <h2 class="w3-center">College Tours - Gallery</h2>

        <div class="w3-content w3-section w3-dark-grey" style="width: 80%; padding: 10px;" >
          <img class="mySlides" src="image/trip1.jpg" style="width:100%">
          <img class="mySlides" src="image/trip2.jpg" style="width:100%">  
          <img class="mySlides" src="image/trip3.jpg" style="width:100%">
          <img class="mySlides" src="image/trip4.jpg" style="width:100%">
          <img class="mySlides" src="image/trip5.jpg" style="width:100%">
          <img class="mySlides" src="image/trip6.jpg" style="width:100%">
          <img class="mySlides" src="image/trip7.jpg" style="width:100%">
          <img class="mySlides" src="image/trip8.jpg" style="width:100%">
          <img class="mySlides" src="image/trip9.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: skyblue;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@College-Trips</u></h1>
  <p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">
    The Govt. Polytechnic College  makes its students visit different places every year likes Pachmarhi, Patalkot, Vrindawan, Gwalior, Bhopal and many other places, and introduced student from places knowledge and their History. 
    <br>
    <br>
