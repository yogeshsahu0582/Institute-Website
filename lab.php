...
<!--header part-->
  ...
  <br>
    ...
    <div class="headimg"><img src="image/labhead.jpg" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>
<br>
    <div class="w3-row">
      <div class="w3-col w3-container m4 l3" style="padding:px">
        <div class="w3-half w3-green w3-container" style="border-radius: 25px; height:auto; width:100%">
          <div class="w3-padding-64 w3-center">
            <h1>INCHARGE</h1>
            <img src="image/ahake.jpg" class="w3-margin w3-circle" alt="Person" style="width:200px">
            <div class="w3-left-align w3-padding-large" style="line-height: 2;">

              <h3 style="font-family:sans-serif;"><b><center>Mr. S.L. Ahake</center></b></h3>
              <p style="font-family:sans-serif;font-size: 20px; text-align: center;">Lab Technician</p>
              <p style="font-family:sans-serif; text-align: center;">Govt. Polytechnic College, Betul</p>
      ...
      <div class="w3-col w3-container m8 l9">  
        <div class="w3-container">
          ...
          <div class="w3-panel w3-card w3-blue-grey" style="border-radius:25px"> 
            <h2><img src="image/lab.png" width="40px"> Smart Lab</h2>

            <div class="w3-code htmlHigh notranslate w3-aqua" style="border-radius: 25px; font-size: 20px;text-align: justify;">

              <h2 class="w3-center">Smart Lab - Gallery</h2>

              <div class="w3-content w3-section w3-dark-grey" style="max-width:90%; padding: 10px;" >
                <img class="mySlides" src="image/lab1.jpg" style="width:100%">
                <img class="mySlides" src="image/lab2.jpg" style="width:100%">  
                <img class="mySlides" src="image/lab3.jpg" style="width:100%">
                <img class="mySlides" src="image/lab4.jpg" style="width:100%">
                <img class="mySlides" src="image/lab5.jpg" style="width:100%">
                <img class="mySlides" src="image/lab6.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: lightseagreen;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Smart - Lab</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">

Govt. Polytechnic College have three Labs for CSE Department as well as ETE Dapartment, Electrical Department & Mechanical Department.
<br>
<br>
GPC Betul each Computer lab is equipped with 50 to 60 computers, all with genuine Windows operating system and 4 GB & 8 GB of RAM with I3 & I5 Processors. These computers are internet enabled and are available for students for their various computing needs. Students can avail the facilities during the free hours – provided the lab is free – or during intervals (provided staff or teachers are available at the lab during this period). The students may avail the facilities to browse topics related to their field of study, to download notes, prepare assignments, prepare presentations or to complete tasks assigned via the google-classrooms.
<br>
<br>
<b>Lab Hours:</b> Monday to Saturday :10:30 a.m. to 5:00 p.m.
</p>
</div>
<br>
