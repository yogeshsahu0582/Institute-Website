...
<!--header part-->
  ...
  <br>
    ...
    <div class="headimg"><img src="image/lib.jpg" width="100%" height="250px" style="padding:10px; border-radius: 25px;"></div>
<br>


    <div class="w3-row">
      <div class="w3-col w3-container m4 l3" style="padding:20px">
        <div class="w3-half w3-blue w3-container" style="width:100%; border-radius:25px">
          <div class="w3-padding-64 w3-center">
            <h1>INCHARGE</h1>
            <img src="image/sanjay.jpg" class="w3-margin w3-circle" alt="Person" style="width:200px">
            <div class="w3-left-align w3-padding-large" style="line-height: 2;">

              <h5 style="font-family:sans-serif;"><b><center>Mr. S.K. Verma</center></b></h5>
              <p style="font-family:sans-serif;text-align: center;">Librarian Clerk</p>
      ...
      <div class="w3-col w3-container m8 l9">  
        <div class="w3-container">
          ...
          <div class="w3-panel w3-card w3-blue-grey" style="border-radius:25px"> 
            <h2><img src="image/library.png" width="40px"> Library</h2>

            <div class="w3-code htmlHigh notranslate w3-aqua" style="font-size: 20px;text-align: justify;">

              <h2 class="w3-center">Library- Gallery</h2>

              <div class="w3-content w3-section w3-dark-grey" style="max-width:90%; padding: 10px;" >
                <img class="mySlides" src="image/lib1.jpg" style="width:100%">
                <img class="mySlides" src="image/lib2.jpg" style="width:100%">  
                <img class="mySlides" src="image/lib3.jpg" style="width:100%">
                <img class="mySlides" src="image/lib4.jpg" style="width:100%">
                <img class="mySlides" src="image/lib5.jpg" style="width:100%">
                <img class="mySlides" src="image/lib6.jpg" style="width:100%">
...
<br>
<div class="w3-container" style="border-radius:25px; background-color: palevioletred;"><h2 style="text-align:center;font-family: cursive; font-weight: bold; border-radius:25px"><u>Info@Library</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">Govt. Polytechnic College Library is stocked with numerous books authored by experts on the subject. The addition of books is a regular feature in the library without missing out on any important title related to the course of study. In addition to the course books, general books, handbooks and reference books are also available. The library subscribes to national and international journals, magazines and national and regional dailies to keep the students in touch with their fields of interest. The library is well furnished and can seat more than 30 students at a time in the spacious reading hall. The peaceful atmosphere in the library plays a major role in helping students concentrate and study better.</p>
</div>
<br>
