...
<!--header part-->
	...
	<div class="headimg"><img src="image/EE.jpg" width="100%" height="250px"></div>
<br>
			...
			<div class="w3-col w3-container m4 l3">
				<div class="w3-half w3-green w3-container" style=" border-radius: 25px; height:auto; width:100%">
					<div class="w3-padding-64 w3-center">
						<h1>HOD DESK</h1>
						<img src="image/sindhe.jpg" class="w3-margin w3-circle" alt="Person" style="width:80%">
						<div class="w3-left-align w3-padding-large" style=" line-height: 2;">

							<h5 style="font-family:sans-serif;"><b><center>Mrs. Preeti Shinde</center></b></h5>
							<p style="font-family:sans-serif;text-align: center;">(HEAD OF DEPARTMENT)</p>
							<p style="font-family:sans-serif; text-align: center;">Electrical Engineering</p>
					...
					<ul class="w3-ul w3-card-4">
						<li class="w3-bar">
							...
							<div class="w3-dropdown-hover">
								<img src="image/sindhe.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/sindhe.jpg"style="width:100%">
								</div>
							</div>
							
							<div class="w3-bar-item">
								<span class="w3-large">Mrs. Preeti Shinde</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							...
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Satish Diwakar</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/dhurve.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/dhurve.jpg" style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large"> Mr. Rajesh Kumar Dhurve</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/laad.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/laad.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Ayush Kumar Laad</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/verma.jpg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/verma.jpg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Miss Chandrika Verma</span><br>
								<span>Lecturer</span>
							</div>
						</li>
						...
						<li class="w3-bar">
							<span onclick="this.parentElement.style.display='none'" ></span>
							<div class="w3-dropdown-hover">
								<img src="image/ishwar.jpeg" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
								<div class="w3-dropdown-content" style="width:300px">
									<img src="image/ishwar.jpeg"  style="width:100%">
								</div>
							</div>
							<div class="w3-bar-item">
								<span class="w3-large">Mr. Ishwar Prasad Dehariya</span><br>
								<span>Lecturer</span>
							</div>
						</li>
					</ul>
...
<br>
<br>
<div class="w3-container" style="background-color: palevioletred;"><h2 style="text-align:center;font-family: cursive; font-weight: bold;"><u>Info@Electrical-Engineering</u></h1>
<p style="text-align:justify; padding:30px; font-size: 22px; font-family: serif;">Diploma in Electrical Engineering is a 3 year skill-enabling engineering programme that students can pursue after completing class 10. The course deals with installation, maintenance, troubleshooting, magnetism, control systems, signal processing and telecommunications.</p>
</div>
<br>
